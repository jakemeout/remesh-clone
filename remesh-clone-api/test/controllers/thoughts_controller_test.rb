...
class ThoughtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post thoughts_url, params: { thought: { date_sent: @thought.date_sent, text: @thought.text } }, as: :json
    end
  ...
  test "should update thought" do
    patch thought_url(@thought), params: { thought: { date_sent: @thought.date_sent, text: @thought.text } }, as: :json
    assert_response 200
  end
